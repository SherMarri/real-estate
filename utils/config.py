# NOTE: this library is not registered on PyPi yet. (https://github.com/google/python-yaml-config)
# python3
...
class _Config(object):
    ...
    """
        ...
        # Load the template
        template = jinja2.Environment(loader=jinja2.BaseLoader, undefined=jinja2.StrictUndefined).from_string(
            yaml_string
        )
